...
namespace FrmAnimais.LP2DataSet1TableAdapters {
    ...
    public partial class animalTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[animal] WHERE (([id] = @Original_id) AND ([nome] = @Original_n" +
                "ome) AND ([tutor] = @Original_tutor) AND ([tipo] = @Original_tipo) AND ([datanas" +
                "c] = @Original_datanasc))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[animal] ([nome], [tutor], [tipo], [datanasc], [foto]) VALUES (" +
                "@nome, @tutor, @tipo, @datanasc, @foto);\r\nSELECT id, nome, tutor, tipo, datanasc" +
                ", foto FROM animal WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[animal] SET [nome] = @nome, [tutor] = @tutor, [tipo] = @tipo, [datanasc] = @datanasc, [foto] = @foto WHERE (([id] = @Original_id) AND ([nome] = @Original_nome) AND ([tutor] = @Original_tutor) AND ([tipo] = @Original_tipo) AND ([datanasc] = @Original_datanasc));
SELECT id, nome, tutor, tipo, datanasc, foto FROM animal WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, tutor, tipo, datanasc, foto FROM dbo.animal";
        ...
        public virtual int Fill(LP2DataSet1.animalDataTable dataTable) {
        ...
        public virtual LP2DataSet1.animalDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LP2DataSet1.animalDataTable dataTable = new LP2DataSet1.animalDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LP2DataSet1.animalDataTable dataTable) {
